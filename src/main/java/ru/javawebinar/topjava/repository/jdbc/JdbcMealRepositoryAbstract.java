...
public class JdbcMealRepositoryAbstract implements MealRepository {
    ...
    @Autowired
    public JdbcMealRepositoryAbstract(JdbcTemplate jdbcTemplate, NamedParameterJdbcTemplate namedParameterJdbcTemplate) {
